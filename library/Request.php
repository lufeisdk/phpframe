...
class Request
{
    ...
    public static function getInstance()
    {
        static $instance;
        if (!$instance) {
            $config = Config::all(BIND_MODULE, 'app');
    ...
    public function cookie($name = '', $default = null, $filter = '')
    {
        if (empty($this->cookie)) {
            $this->cookie = Cookie::getInstance()->get();
        }
    ...
    {
        return $this->module ?: BIND_MODULE;
    }
    ...
    {
        $name = $this->controller ?: BIND_CONTROLLER;
    ...
    public function token($name = '__token__', $type = null)
    {
        ...
        Session::getInstance()->set($name, $token);
